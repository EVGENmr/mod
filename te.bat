...
start "" /wait "C:\modification\JDK.exe" "/s REBOOT=ReallySuppress INSTALL_DIR=C:\Program Files\Java\jdk-8u181"
start "" /wait "C:\modification\IDEA.exe" "/S /VERYSILENT /NORESTART"
